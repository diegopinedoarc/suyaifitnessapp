  ...
  return (
    <SectionWrapper>
      <MainActivity>
        ...
        <MainActInfoDiv>
          <MainActTitle style={{ fontFamily: "var(--fuente1)" }}>
            ENTRAMIENTO
          </MainActTitle>
          <MainInfo>
            Lunes a Viernes: 7:00Hs a 11:00Hs/ 18Hs A 21Hs <br /> Sabados 9Hs A
            12:00Hs
          </MainInfo>
        </MainActInfoDiv>
      </MainActivity>
      ...
      <MainActivity2>
        <MainActInfoDiv>
          <MainActTitle
            style={{ fontFamily: "var(--fuente1)", fontSize: "1.8rem" }}
          >
            Boxeo recreativo y competitivo
          </MainActTitle>
          <MainInfo>
            Martes y jueves: DE 10Hs A 11:30Hs, 18.30Hs A 20Hs
          </MainInfo>
        </MainActInfoDiv>
